                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-3 text-sm">
                                            ...
                                            <div className={`p-3 rounded-xl flex flex-col shadow-inner transition duration-150 relative ${awayClasses}`}>
                                                ...
                                                <div className="sm:hidden flex absolute bottom-0 right-0 margin-top '-.75'">
                                                    <div className="flex bottom-0 right-0 p-1 px-2 bg-indigo-600 text-white text-xs font-bold rounded-lg shadow-md flex items-center space-x-1 margin-top '-.75'">
